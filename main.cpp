...
int main1()
{
	...
	auto BuildInjectionResponse = [&](SystemModal& modal, std::vector<float>& out, bool stepMode)
		{
			...
			if (stepMode) modal.InjectStep(ResponseTau, 1.0f);
	...
	{
		-19506.4127107f, 21961.4787328f, -0.758982041328f, 0.523330945704f,
		-16767.6311614f, 62613.770361f, 0.352110028615f, 0.0281057631927f,
		-12551.4178222f, 95100.5976256f, -0.157612131307f, -0.0783091455843f,
		-8245.59450592f, 117845.196905f, 0.0621208052484f, 0.066859812778f,
		-4540.82297377f, 131679.084666f, -0.0145032762656f, -0.039976785287f,
		-1435.83467349f, 138102.21307f, -0.000171987958974f, 0.012390071958f
	};

	std::vector<float> onePoleParams =
	{
		-17.6776695297f, -3.29609569961e-05f,
		-565.685424949f, 0.0341102791514f
	};
